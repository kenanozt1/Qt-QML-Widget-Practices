...
public:
    ...
    QAction *actionFont;
    QAction *actionColor;
    QAction *actionText_Background_Color;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/img/save_as.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSave_as->setIcon(icon3);
        actionCut = new QAction(MainWindow);
        actionCut->setObjectName(QString::fromUtf8("actionCut"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/img/cut.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCut->setIcon(icon4);
        actionCopy = new QAction(MainWindow);
        actionCopy->setObjectName(QString::fromUtf8("actionCopy"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/img/copy.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionCopy->setIcon(icon5);
        actionPaste = new QAction(MainWindow);
        actionPaste->setObjectName(QString::fromUtf8("actionPaste"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/img/paste.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionPaste->setIcon(icon6);
        actionRedo = new QAction(MainWindow);
        actionRedo->setObjectName(QString::fromUtf8("actionRedo"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/img/redo.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRedo->setIcon(icon7);
        actionUndo = new QAction(MainWindow);
        actionUndo->setObjectName(QString::fromUtf8("actionUndo"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/img/undo.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/img/info.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAbout_Notepad->setIcon(icon9);
        actionAbout_Notepad->setShortcutContext(Qt::WidgetShortcut);
        actionFont = new QAction(MainWindow);
        actionFont->setObjectName(QString::fromUtf8("actionFont"));
        actionColor = new QAction(MainWindow);
        actionColor->setObjectName(QString::fromUtf8("actionColor"));
        actionText_Background_Color = new QAction(MainWindow);
        actionText_Background_Color->setObjectName(QString::fromUtf8("actionText_Background_Color"));
        actionPalette_color = new QAction(MainWindow);
        actionPalette_color->setObjectName(QString::fromUtf8("actionPalette_color"));
        ...
        menuEdit->addAction(actionText_Background_Color);
        menuEdit->addAction(actionPalette_color);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionText_Background_Color->setText(QCoreApplication::translate("MainWindow", "Text Background Color", nullptr));
